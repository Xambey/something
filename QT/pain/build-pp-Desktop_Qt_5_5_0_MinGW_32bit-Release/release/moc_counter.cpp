...
QT_MOC_LITERAL(1, 8, 7), // "goodbye"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 14), // "counterChanged"
QT_MOC_LITERAL(4, 32, 7) // "slotInc"
...
void Counter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Counter::goodbye)) {
                *result = 0;
            }
        }
        {
            typedef void (Counter::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Counter::counterChanged)) {
                *result = 1;
            }
        }
    }
